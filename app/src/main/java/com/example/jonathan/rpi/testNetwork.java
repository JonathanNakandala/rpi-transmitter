...
/**
 * testNetwork Class used to communicate with RPI.
 * Created on 05/06/15.
 */
public class testNetwork extends AsyncTask<String, Integer, String> {
    //private Context mContext;
    private ProgressBar progressSpinner;
    private Context mainContext;

    public testNetwork(ProgressBar progression, Context contex) {
